...
const theme = `static/css/theme_${themeName}.css`
...
if (localStorage["belleTheme"]) {
    ...
    themeElem.setAttribute("href", "static/css/theme_two.css")
}
...
function listen(element, eventType) {
    element.addEventListener(eventType, (e) => {
        ...
        themeElem.setAttribute("href", `static/css/theme_${themeUrl}.css`)
    })
}